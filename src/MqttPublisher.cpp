...
void MqttPublisher::setup() {
  ...
  mClient.onConnect(
      std::bind(&MqttPublisher::onMqttConnected, this, std::placeholders::_1));
  mClient.onDisconnect(std::bind(&MqttPublisher::onMqttDisconnected, this,
                                 std::placeholders::_1));
  mClient.onPublish(
      std::bind(&MqttPublisher::onMqttPublish, this, std::placeholders::_1));
...
void MqttPublisher::onWiFiDisconnected(
...
void MqttPublisher::onMqttDisconnected(
