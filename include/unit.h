...
dlms_unit_t dlms_units[] = {
    ...
    {15, "m³/h"},      // volume flux   cubic metre per hour
                       // m³/(60*60s)
    {16,
     "m³/h"},      // corrected volume flux cubic metre per hour  m³/(60*60s)
    {17, "m³/d"},  // volume flux
                   // m³/(24*60*60s)
    {18,
     "m³/d"},    // corrected volume flux    m³/(24*60*60s)
    {19, "l"},   // volume   litre   10-3 m³
    {20, "kg"},  // mass (m)   kilogram
    {21, "N"},   // force (F)   newton
    {22,
     "Nm"},  // energy   newtonmeter  J = Nm = Ws
    {23,
     "Pa"},  // pressure (p)   pascal   N/m²
    {24,
     "bar"},  // pressure (p)   bar   10⁵ N/m²
    {25,
     "J"},  // energy   joule   J = Nm = Ws
    {26,
     "J/h"},      // thermal power  joule per hour  J/(60*60s)
    {27, "W"},    // active power (P)  watt   W = J/s
    {28, "VA"},   // apparent power (S)  volt-ampere
    {29, "var"},  // reactive power (Q)  var
    {30,
     "Wh"},        // active energy  watt-hour  W*(60*60s)
    {31, "VAh"},   // apparent energy  volt-ampere-hour
                   // VA*(60*60s)
    {32, "varh"},  // reactive energy  var-hour
                   // var*(60*60s)
    ...
    {37,
     "F"},          // capacitance (C)  farad   C/V = As/V
    ...
    {42,
     "A/m"},           // magnetic field strength (H) ampere per metre A/m
    ...
    {46, "1/(varh)"},  // R_B
                       // (reactive
                       // energy meter constant or pulse value)
    {47, "1/(VAh)"},   // R_S
                       // (apparent energy meter constant or pulse value)
    {48, "V²h"},       // volt-squared hour  volt-squaredhours
                       // V²(60*60s)
    {49, "A²h"},       // ampere-squared hour  ampere-squaredhours
                       // A²(60*60s)
    ...
    {60,
     "Wh/m³"},     // energy per volume     3,6*103
                   // J/m³
    {61, "J/m³"},  // calorific value, wobbe
    {62,
     "Mol %"},  // molar fraction of  mole percent  (Basic
                // gas
                // composition
                // unit)
                // gas composition
    {63,
     "g/m³"},             // mass density, quantity of material   (Gas
                          // analysis,
                          // accompanying elements)
    {64, "Pa s"},         // dynamic viscosity pascal second
                          // (Characteristic
                          // of
                          // gas stream)
